...
class NewRankingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
            ...
            ranking1.text = "1位 : " + String(defaults.integer(forKey: "score1"))
            ranking2.text = "2位 : " + String(defaults.integer(forKey: "score2"))
            ranking3.text = "3位 : " + String(defaults.integer(forKey: "scores3"))
